...
export const ITEMS = {
    airstrike: {
        name: 'airstrike',
        activate: () => (game.itemcontroller.airstrike = true),
        icon: AIRSTRIKE_ICON,
    ...
    bomb: {
        name: 'bomb',
        activate: () => (game.itemcontroller.bomb = true),
        icon: BOMBS_ICON,
        pause: BOMBS_PAUSE,
    ...
    darts: {
        name: 'darts',
        activate: () => (game.itemcontroller.darts = true),
        icon: DARTS_ICON,
        pause: DARTS_PAUSE,
    ...
    drones: {
        name: 'drones',
        activate: () => (game.itemcontroller.drones = true),
        icon: DRONES_ICON,
        pause: DRONES_PAUSE,
    ...
    emp: {
        name: 'emp',
        activate: () => (game.itemcontroller.emp = true),
        icon: EMP_ICON,
        pause: EMP_PAUSE,
    ...
    greed: {
        name: 'greed',
        activate: () => (game.itemcontroller.greed = true),
        icon: GREED_ICON,
        pause: GREED_PAUSE,
    ...
    loopers: {
        name: 'loopers',
        activate: () => (game.itemcontroller.loopers = true),
        icon: LOOPERS_ICON,
        pause: LOOPERS_PAUSE,
    ...
    machinegun: {
        name: 'machinegun',
        activate: () => (game.itemcontroller.machinegun = true),
    ...
    metalshield: {
        name: 'metalshield',
        activate: () => (game.itemcontroller.metalshield = true),
    ...
    multiplydamage: {
        name: 'multiplydamage',
        activate: () => game.itemcontroller.incrementDamageMultiplier(),
        icon: DAMAGE_ICON,
        pause: DAMAGE_PAUSE,
    ...
    nitrogen: {
        name: 'nitrogen',
        activate: () => (game.itemcontroller.nitrogen = true),
        icon: NITROGEN_ICON,
    ...
    rocket: {
        name: 'rocket',
        activate: () => (game.itemcontroller.rocket = true),
        icon: ROCKET_ICON,
        pause: ROCKET_PAUSE,
    ...
    seekers: {
        name: 'seekers',
        activate: () => (game.itemcontroller.seekers = true),
        icon: SEEKERS_ICON,
        pause: SEEKERS_PAUSE,
    ...
    spray: {
        name: 'spray',
        activate: () => game.itemcontroller.spray++,
        icon: SPRAY_ICON,
        pause: SPRAY_PAUSE,
    ...
    uranium: {
        name: 'uranium',
        activate: () => (game.itemcontroller.uranium = true),
        icon: URANIUM_ICON,
        pause: URANIUM_PAUSE,
